...
const std::string COMPUTER3_IP = "10.10.58.77";       // Ip of computer 3
...
int connect_socket_2() {
    ...
    serverAddr.sin_addr.s_addr = inet_addr(COMPUTER3_IP.c_str());
    ...
    std::cout << "Connected to server at " << COMPUTER3_IP << ":" << PORT2 << std::endl;
